...
export const FirstLastFrame: React.FC = () => {
  return (
    <div className="h-full overflow-hidden flex flex-col gap-4">
      <div className="bg-(--text-color)/20 p-1! rounded-sm flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <div className="h-30 flex-1 flex flex-col hover:opacity-80 items-center justify-center cursor-pointer border border-dashed rounded-md bg-(--text-color)/10 border-(--text-color)/50">
        ...
        <div className="h-30 flex flex-1 flex-col hover:opacity-80 items-center justify-center cursor-pointer border border-dashed rounded-md bg-(--text-color)/10 border-(--text-color)/50">
          <IoMdAdd style={{ fontSize: "24px" }} />
      ...
      <div className="flex-1 border border-(--border-color) rounded-xl p-2!">
