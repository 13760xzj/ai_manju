    ...
    <div className="settings-page">
      <div className="page-toolbar">
        ...
        <div className="toolbar-right">
          <button className="btn-small btn-secondary" onClick={handleZoomIn}>🔍 放大 +</button>
          <button className="btn-small btn-secondary" onClick={handleZoomOut}>🔍 缩小 -</button>
          <button className="btn-small btn-secondary" onClick={handleReGenerateVideo}>重新生成视频</button>
          <button className="btn-small btn-secondary" onClick={handleExportVideo}>导出视频</button>
          <button className="btn-small btn-primary-small" onClick={handleSaveProject}>保存项目</button>
        </div>
      </div>
            ...
            <div className="tracks-wrapper">
              ...
              <div className="tracks-area">
                ...
                <div className="track track-music">
                  <div className="music-clip" style={{ width: '2000px' }} onClick={handleReplaceMusic}>
                    <div className="clip-handle clip-handle-left"></div>
