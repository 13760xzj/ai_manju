  ...
  return (
    <div className="create-work-page">
      ...
      >
        <IconButton
          ariaLabel="关闭"
          className="create-work-close"
          onClick={handleClose}
        >
          <IoMdClose style={{ color: "var(--text-color)" }} />
        </IconButton>

        <div className="create-work-header">
          <div className="create-work-title">新建作品</div>
          <div className="create-work-subtitle">
            仅需填写名称，即可新建作品（所有作品素材将自动保存在资产库）
          </div>
        </div>

        <div className="create-work-form">
          <div className="create-work-label">
            作品名称(单集){" "}
            <span className="create-work-label-hint">
              （适用于有连续剧情的作品）
            </span>
          </div>
        ...
        <div className="create-work-footer">
          ...
          <Button
            ...
            className="create-work-btn primary"
          >
            确定新建
          </Button>
        </div>
